...
class TestBSSSlurm(unittest.TestCase):
    ...
    def test_parse_qstat(self):
        ...
        self.assertTrue("182867 RUNNING large" in result)
        self.assertTrue("182917 RUNNING batch" in result)
        self.assertTrue("182588 QUEUED batch" in result)
        self.assertTrue("182732 RUNNING large" in result)
        self.assertTrue("182744 QUEUED large" in result)
        self.assertTrue("182745 RUNNING small" in result)
        self.assertTrue("182800 COMPLETED small" in result)
        self.assertTrue("123456 QUEUED small RESV_DEL_HOLD\n" in result)
